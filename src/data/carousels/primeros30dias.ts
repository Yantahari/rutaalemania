...
const slides: CarouselSlide[] = [
  ...
  // Slide 3 — Anmeldung
  {
    ...
    stepBadge: 'Día 2-4',
    cardContent:
      'Tienes <span class="cb-gold">dos semanas desde que te instalas</span> —no desde que aterrizas— para registrar tu domicilio en la Bürgeramt.<br><br>Sin la Meldebescheinigung <span class="cb-gold">casi todo se atasca</span> — aunque firmar contrato o abrir una cuenta básica no te lo pueden negar por ley.',
  },
